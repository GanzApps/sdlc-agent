...
description: use this agent when consuming monitoring-driven incident tickets and delivering a production fix with logs, metrics, self-healing guardrails, tests, and a pull request.
---
