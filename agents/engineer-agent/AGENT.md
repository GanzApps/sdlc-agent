---
name: engineer-agent
description: use this agent when consuming approved engineering tickets and implementing production-ready code with logging, monitoring, self-healing, unit tests, and e2e tests.
---
