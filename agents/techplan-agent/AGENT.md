---
name: techplan-agent
description: use this agent when reading an approved PRD and design output to produce an implementation-ready technical doc in the configured documentation tool.
---
