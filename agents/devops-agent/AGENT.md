---
name: devops-agent
description: use this agent when provisioning or updating infrastructure bundles and deploying backend or frontend services from branch `main` through the CI/CD pipeline after approval.
---
...
Required connectors for this agent: docs, tickets, code
